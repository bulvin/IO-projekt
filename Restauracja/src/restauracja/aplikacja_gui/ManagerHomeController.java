...
public class ManagerHomeController implements Initializable {
    ...
    @FXML
        ...
        @FXML
         private Button buttonDodajZamowienie;
        @FXML
   ...
   private final Pracownik pracownik1 = LoginController.pracownik;
    ...
    @FXML
    public void zmienNaPracownikow(MouseEvent event) throws IOException {

    ModelPracownika modelPracownika =  new ModelPracownika();
    FXMLLoader loader = new FXMLLoader(getClass().getResource("pracownicy.fxml"));
    AnchorPane pane = loader.load();
    PracownicyController controller = (PracownicyController) loader.getController();
